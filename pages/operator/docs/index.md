...
The controller will then check the crd and decrypt the data in it, creating a Kubernetes Secret from that.
...
This project was initialized using [Kubebuilder](https://github.com/kubernetes-sigs/kubebuilder){target="_blank"}, a common tool used by most developers building an Operator. 
