...
The controller will then check the encrypted secrets and decrypt them, creating a default Kubernetes Secret in the cluster.
...
This project was initialized using kubebuilder, a common tool used by most developers building operators. 
