...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgeSecretTemplate) DeepCopyInto(out *AgeSecretTemplate) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgeSecretTemplate.
func (in *AgeSecretTemplate) DeepCopy() *AgeSecretTemplate {
	if in == nil {
		return nil
	}
	out := new(AgeSecretTemplate)
	in.DeepCopyInto(out)
	return out
}
